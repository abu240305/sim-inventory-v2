<div class="card hero shadow-lg h-100">
      ...
      <img src="{{ asset('assets/img/illustrations/characters-pu.png') }}" alt=""
         class="hero__character d-none d-lg-block" aria-hidden="true">
            ...
            <div>
               <div class="d-flex align-items-center gap-3">
                  <div class="hero__logo">
                     <img src="{{ asset('assets/img/logo-pu.jpeg') }}" alt="Logo Kementerian Pekerjaan Umum">
                  </div>
