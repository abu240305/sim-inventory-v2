  ...
  <div class="card-body">
    <form method="POST" action="{{ route('barang.store') }}">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="kondisi" name="kondisi" value="{{ old('kondisi') }}" placeholder="Contoh: Baik, Rusak Ringan" />
      </div>

      <div class="mb-3">
        <label class="form-label" for="lokasi">Lokasi</label>
        <input type="text" class="form-control" id="lokasi" name="lokasi" value="{{ old('lokasi') }}" placeholder="Contoh: Gudang Utama, Lemari A" />
      </div>
